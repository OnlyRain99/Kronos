                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label>From</label>
                                                <input type="date" name="ss_datefrom" id="datefrom" onchange="daterange()" class="form-control" required>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label>To</label>
                                                <input type="date" name="ss_dateto" id="dateto" onchange="daterange()" class="form-control" required>
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <table class="table table-bordered" style="font-family: 'Calibri'; font-size: 14px;">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <?php  
                                                            ...
                                                            $request=$link->query("SELECT `gy_req_id`,`gy_req_code`,`gy_req_date`,`gy_req_status` From `gy_request` Where `gy_req_by`='$user_id' AND `gy_req_status`!='0' GROUP BY(`gy_req_code`) ORDER BY `gy_req_id` DESC LIMIT 20");
...
'left=20,top=20,width=1280,height=720,toolbar=1,resizable=0'); return false;"><button type="button" class="btn btn-warning btn-sm" title="click to view schedules ..."><i class="fa fa-eye"></i></button></a></td>
                                                        </tr>
