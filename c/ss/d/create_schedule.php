                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <strong class="card-title mb-3">PROCESS ID: <span style="color: blue;"><?= $myreqcode; ?></strong>
                                </div>
                                <div class="card-body">
                                    <form method="post" enctype="multipart/form-data" action="add_c_sched?cd=<?= $myreqcode; ?>" onsubmit="validateForm(this);">
                                    <div class="row">
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label>From</label>
                                                <input type="date" name="datefrom" id="datefrom" min="<?= date("Y-m-d", strtotime($onlydate." +1 day")); ?>" onchange="daterange()" class="form-control" required>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <button type="submit" name="submit" id="submit" class="btn btn-success btn-block" title="click to Add ..."><i class="fa fa-plus"></i> Add Request</button>
                                            </div>
                                        </div>
                                    </div>
                                    </form>
                                    ...
                                    <div class="row">
                                                            ...
                                                            <div class="modal-dialog modal-sm" role="document">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-footer">
                                                                        ...
                                                                        <a href="delete_c_sched?cd=<?php echo $reqrow['gy_req_id']; ?>"><button type="button" class="btn btn-danger">Confirm</button></a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <button type="button" data-toggle="modal" data-target="#send" class="btn btn-primary btn-block" title="click to submit request ...">Submit Requests <i class="fa fa-paper-plane"></i></button>
                                        </div>
                                    </div>
