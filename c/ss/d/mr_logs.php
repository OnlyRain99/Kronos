...
<ul class="nav nav-tabs">
  <li class="nav-item">
    <button class="nav-link " onclick="checkreports()">Scheduled Reports</button>
  </li>
  <li class="nav-item">
    <button class="nav-link active" onclick="checkticketlogs()">Ticket Logs</button>
  </li>
</ul>
...
<div class="input-group">
  <div class="input-group-prepend">
    ...
    <select class="form-control" id="searchempsellogs">
        <option></option>
        <?php
  ...
  <button class="btn btn-outline-secondary" id="btnsearchrptlogs" onclick="searchempreplogs(this)" >Search <i class="fas fa-search"></i></button>
    ...
    <table class="table table table-bordered" style="font-family: 'Calibri'; font-size: 14px;">
        <thead>
            <tr>
                ...
                <th scope="col" style="padding: 10px;" class="text-center">Time</th>
                <th scope="col" style="padding: 10px;" class="text-center">Channel</th>
                <th scope="col" style="padding: 10px;" class="text-center">Ticket ID</th>
            </tr>
        </thead>
