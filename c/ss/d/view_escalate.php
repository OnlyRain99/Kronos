<?php 
    ...
    $request=$link->query("SELECT `gy_esc_type`,`gy_esc_reason`,`gy_tracker_id`,`gy_tracker_date`,`gy_tracker_login`,`gy_tracker_breakout`,`gy_tracker_breakin`,`gy_tracker_logout`,`gy_tracker_wh`,`gy_tracker_bh`,`gy_tracker_ot` From `gy_escalate` Where `gy_esc_id`='$redirect'");
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <strong class="card-title mb-3">Request: <span style="color: blue;"><?= escalate_type($req['gy_esc_type']) ?></span> <span class="pull-right"><a href="download?cd=<?= $redirect; ?>"><button type="button" class="btn btn-success btn-sm" title="click to download attachment ..."><i class="fa fa-download"></i> Download Escalate Form</button></a></span></strong>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="table-responsive m-b-40">
                                                <table class="table table-bordered" style="font-family: 'Calibri'; font-size: 14px;">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr class="<?= mybackg($track['gy_tracker_wh'], $req['gy_tracker_wh']) ?>">
                                                            <th style="padding: 5px;" class="text-center">WH</th>
                                                            <td style="padding: 5px;" class="text-center"><?= $track['gy_tracker_wh']; ?></td>
                                                            <td style="padding: 5px; color: blue;" class="text-center"><?= $req['gy_tracker_wh']; ?></td>
                                                        </tr>
                                                        <tr class="<?= mybackg($track['gy_tracker_bh'], $req['gy_tracker_bh']) ?>">
                                                            <th style="padding: 5px;" class="text-center">BH</th>
                                                            <td style="padding: 5px;" class="text-center"><?= $track['gy_tracker_bh']; ?></td>
                                                            <td style="padding: 5px; color: blue;" class="text-center"><?= $req['gy_tracker_bh']; ?></td>
                                                        </tr>
                                                        <tr class="<?= mybackg($track['gy_tracker_ot'], $req['gy_tracker_ot']) ?>">
                                                            <th style="padding: 5px;" class="text-center">OT</th>
                                                            <td style="padding: 5px;" class="text-center"><?= $track['gy_tracker_ot']; ?></td>
                                                            <td style="padding: 5px; color: blue;" class="text-center"><?= $req['gy_tracker_ot']; ?></td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            </div>
