<?php 
    ...
    if ($s != "" && $f != "" && $t != "") {
        ...
        if ($l == 0) {
            $title = "My Team Search: ".$s." - ".$finaldate." -> All";
        }else{
            $title = "My Team Search: ".$s." - ".$finaldate." -> ".getuserfullname($l);
        }

    }if ($s == "" && $f != "" && $t != "") {

        if ($l == 0) {
            $title = "My Team Search: ".$finaldate." -> All";
        }else{
            $title = "My Team Search: ".$finaldate." -> ".getuserfullname($l);
        }
    }
?>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <!--<div class="form-group">
                                <input type="text" name="master_search" class="form-control" placeholder="search here and select date ...">
                            </div>-->
                        </div> 
                        <div class="col-lg-3">
                            <div class="form-group">
                                <label>From <span style="color: red;">*required</span></label>
                                <input type="date" name="from" id="datefrom" onchange="daterange()" class="form-control" value="<?= $f; ?>" required>
                            </div>
                        </div>
                        <div class="col-lg-3">
                            <div class="form-group">
                                <label>To <span style="color: red;">*required</span></label>
                                <input type="date" name="to" id="dateto" onchange="daterange()" class="form-control" value="<?= $t; ?>" required>
                            </div>
                        </div>
                        <div class="col-lg-3">
                            <div class="form-group">
                                <label>Select L1 / <span style="color: green;">L2</span></label>
                                ...
                                <div class="card-body card-block" id="accordion">
                                    ...
                                    <?php
                                        if ($l == 0) {
                                            ...
                                            $level=$link->query("SELECT `gy_employee`.`gy_emp_id`,`gy_employee`.`gy_emp_fullname`,`gy_employee`.`gy_emp_account`,`gy_user`.`gy_user_id`,`gy_user`.`gy_user_type` From `gy_employee` LEFT JOIN `gy_user` On `gy_employee`.`gy_emp_code`=`gy_user`.`gy_user_code` Where `gy_user_id`='$l'");
                                        }
                                                        ...
                                                        <tbody>
                                                            <?php  
                                                                if ($s != "" && $f != "" && $t != "") {
                                                                    ...
                                                                    //all fields search
                                                                    $title = "Request Search: ".$s." - ".$finaldate;

                                                                    $statement="SELECT `gy_employee`.`gy_emp_id`, `gy_employee`.`gy_emp_code`, `gy_employee`.`gy_emp_supervisor`, `gy_employee`.`gy_emp_lastedit`,`gy_tracker`.`gy_tracker_id`, `gy_tracker`.`gy_tracker_code`, `gy_tracker`.`gy_tracker_date`, `gy_tracker`.`gy_emp_email`, `gy_tracker`.`gy_emp_fullname`, `gy_tracker`.`gy_emp_account`, `gy_tracker`.`gy_tracker_login`, `gy_tracker`.`gy_tracker_breakout`, `gy_tracker`.`gy_tracker_breakin`, `gy_tracker`.`gy_tracker_logout`, `gy_tracker`.`gy_tracker_wh`, `gy_tracker`.`gy_tracker_bh`, `gy_tracker`.`gy_tracker_ot`, `gy_tracker`.`gy_tracker_status`, `gy_tracker`.`gy_tracker_request`, `gy_tracker`.`gy_tracker_reason`, `gy_tracker`.`gy_tracker_remarks`, `gy_tracker`.`gy_tracker_history`, `gy_tracker`.`gy_tracker_om` FROM `gy_employee` LEFT JOIN `gy_tracker` On `gy_employee`.`gy_emp_code`=`gy_tracker`.`gy_emp_code` Where CONCAT(`gy_tracker`.`gy_emp_email`,`gy_tracker`.`gy_emp_fullname`,`gy_tracker`.`gy_emp_code`) LIKE '%$s%' AND ".$condition." AND date(`gy_tracker`.`gy_tracker_date`) BETWEEN '$f' AND '$t' Order By `gy_tracker`.`gy_tracker_request` != '',`gy_tracker`.`gy_emp_fullname` ASC";
                                                                }if ($s == "" && $f != "" && $t != "") {

                                                                    //dates
                                                                    $title = "Request Search: ".$finaldate;

                                                                    $statement="SELECT `gy_employee`.`gy_emp_id`, `gy_employee`.`gy_emp_code`, `gy_employee`.`gy_emp_supervisor`, `gy_employee`.`gy_emp_lastedit`,`gy_tracker`.`gy_tracker_id`, `gy_tracker`.`gy_tracker_code`, `gy_tracker`.`gy_tracker_date`, `gy_tracker`.`gy_emp_email`, `gy_tracker`.`gy_emp_fullname`, `gy_tracker`.`gy_emp_account`, `gy_tracker`.`gy_tracker_login`, `gy_tracker`.`gy_tracker_breakout`, `gy_tracker`.`gy_tracker_breakin`, `gy_tracker`.`gy_tracker_logout`, `gy_tracker`.`gy_tracker_wh`, `gy_tracker`.`gy_tracker_bh`, `gy_tracker`.`gy_tracker_ot`, `gy_tracker`.`gy_tracker_status`, `gy_tracker`.`gy_tracker_request`, `gy_tracker`.`gy_tracker_reason`, `gy_tracker`.`gy_tracker_remarks`, `gy_tracker`.`gy_tracker_history`, `gy_tracker`.`gy_tracker_om` FROM `gy_employee` LEFT JOIN `gy_tracker` On `gy_employee`.`gy_emp_code`=`gy_tracker`.`gy_emp_code` Where ".$condition." AND date(`gy_tracker`.`gy_tracker_date`) BETWEEN '$f' AND '$t' Order By `gy_tracker`.`gy_tracker_request` != '',`gy_tracker`.`gy_emp_fullname` ASC";
                                                                }
                                                            ...
                                                            <tr class="mybg">
                                                                ...
                                                                <?php if($btn_status != "disabled"){ ?>
                                                                    <a href="escalate?cd=<?= $trackrow['gy_tracker_id']; ?>" onclick="window.open(this.href, 'mywin',
																'left=20,top=20,width=1280,height=720,toolbar=1,resizable=0'); return false;"><?php } ?>
																	<button type="button" class="btn btn-info btn-sm" title="click to escalate ..."><i class="fa fa-arrow-circle-up"></i></button>
																<?php if($btn_status != "disabled"){ ?></a><?php } ?>
                                                                </td>
                                                            </tr>

                                                            <?php 
                                                                $timekeep = "update_timekeep?cd=".$trackrow['gy_tracker_id']."&mode=search&s=$s&f=$f&t=$t&l=$l";
                                                                $statuschange = "statuschange?cd=".$trackrow['gy_tracker_id']."&mode=search&s=$s&f=$f&t=$t&l=$l";
