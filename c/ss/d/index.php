<?php 
    ...
    //get employee info
    $getemp=$link->query("SELECT `gy_emp_id`,`gy_emp_code`,`gy_emp_email`,`gy_emp_fullname`,`gy_work_from`,`gy_emp_type` From `gy_employee` Where `gy_emp_code`='$user_code'");
...
$if_userip = 0;
if($emprow['gy_emp_type']==3){ $if_userip = 1; }
