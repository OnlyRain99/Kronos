<?php 
    ...
    $schedules=$link->query("SELECT `gy_req_id`,`gy_emp_code`,`gy_emp_fullname`,`gy_sched_day`,`gy_sched_mode`,`gy_sched_login`,`gy_sched_breakout`,`gy_sched_breakin`,`gy_sched_logout`,`gy_req_reason` From `gy_request` Where `gy_req_code`='$redirect' AND CONCAT(`gy_emp_code`,`gy_emp_fullname`) LIKE '%$search_text%' Order By `gy_emp_fullname` ASC");
    $countsched=$schedules->num_rows;
?>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <strong class="card-title mb-3">Data Table - <span style="font-style: italic; color: blue;"><?= $countsched; ?> results</span></strong>
                                </div>
                                <div class="card-body">
                                                ...
                                                <table class="table table-bordered" style="font-family: 'Calibri'; font-size: 14px;">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <?php  
                                                            ...
                                                            while ($reqrow=$schedules->fetch_array()) {
