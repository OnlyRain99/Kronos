        ...
        <div class="page-container">
            <div class="main-content" style="padding: 20px;">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h2 class="title-1 m-b-25"><?php echo $title; ?> <i class="fa fa-book"></i></h2>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
...
<div class="input-group-prepend">
    <div class="form-floating minwid-120">
        <select class="form-select" id="slt_depact" required>
            <?php $depsql=$link->query("SELECT `gy_acc_id`,`gy_acc_name` From `gy_accounts` Where `gy_acc_id`='$myaccount'");
    ...
    <button class="btn btn-outline-secondary btn-lg float-right" title="Download" id="dwnld" onclick="dlemprep()"><i class="fas fa-download faa-float animated faa-slow"></i></button>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table table-bordered" style="font-family: 'Calibri'; font-size: 14px;">
                                            <thead>
                                                <tr>
                                                    <th scope="col" style="padding: 2px;" class="text-center">Agent Name</th>
                                                    <th scope="col" style="padding: 2px;" class="text-center">Date</th>
                                                    <th scope="col" style="padding: 2px;" class="text-center text-nowrap">Total transaction</th>
                                                    <th scope="col" style="padding: 2px;" class="text-center">Team Lead</th>
                                                    <th scope="col" style="padding: 2px;" class="text-center text-nowrap">Schedule In</th>
                                                    <th scope="col" style="padding: 2px;" class="text-center text-nowrap">Schedule Out</th>
                                                    <th scope="col" style="padding: 2px;" class="text-center text-nowrap">Actual Log In</th>
                                                    <th scope="col" style="padding: 2px;" class="text-center text-nowrap">Actual Log Out</th>
                                                    <th scope="col" style="padding: 2px;" class="text-center">Day</th>
                                                    <th scope="col" style="padding: 2px;" class="text-center text-nowrap">Total Hour</th>
                                                    <th scope="col" style="padding: 2px;" class="text-center text-nowrap">Total Hour(LB)</th>
                                                </tr>
                                            </thead>
...
<script type="text/javascript">
    ...
    function upd_usrlst(){
        var slctval = document.getElementById("slt_depact").value;
        if(slctval!=""){
    ...
    function dsply_timesheet(){
        document.getElementById("rfrsh").innerHTML = '<i class="fas fa-refresh fa-spin"></i>';
