    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="mediumModalLabel"><i class="fa fa-edit"></i> Edit <span style="color: blue;"><?php echo $trackrow['gy_emp_fullname']; ?></span> Time Logs<span style="color: blue;"></h5>
                    ...
                    <div class="col-md-6">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Time</label>
                                    <input type="time" class="form-control" name="logintime" value="<?php echo puretime(date('H:i:s', strtotime($trackrow['gy_tracker_login']))); ?>" required>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Time</label>
                                    <input type="time" class="form-control" name="breakouttime" value="<?php echo puretime(date('H:i:s', strtotime($trackrow['gy_tracker_breakout']))); ?>" >
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Time</label>
                                    <input type="time" class="form-control" name="breakintime" value="<?php echo puretime(date('H:i:s', strtotime($trackrow['gy_tracker_breakin']))); ?>" >
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Time</label>
                                    <input type="time" class="form-control" name="logouttime" value="<?php echo puretime(date('H:i:s', strtotime($trackrow['gy_tracker_logout']))); ?>" required>
                                </div>
                            </div>
                        </div>
                    </div>
