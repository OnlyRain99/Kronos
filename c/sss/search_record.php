<?php 
    ...
    $title = "Daily Logs Search: ".$finaldate;

    $query_one = "SELECT * From `gy_tracker` Where `gy_emp_code`='$user_code' AND date(`gy_tracker_date`) BETWEEN '$datef' AND '$datet' Order By `gy_tracker_date` ASC";

    $query_two = "SELECT COUNT(`gy_tracker_id`) From `gy_tracker` Where `gy_emp_code`='$user_code' AND date(`gy_tracker_date`) BETWEEN '$datef' AND '$datet' Order By `gy_tracker_date` ASC";

    $query_three = "SELECT * From `gy_tracker` Where `gy_emp_code`='$user_code' AND date(`gy_tracker_date`) BETWEEN '$datef' AND '$datet' Order By `gy_tracker_date` ASC ";

    $my_num_rows = 20;

    //get accounts
    $tracker=$link->query("SELECT * From `gy_tracker` Where `gy_emp_code`='$user_code' AND date(`gy_tracker_date`) BETWEEN '$datef' AND '$datet' Order By `gy_tracker_date` ASC");
                    ...
                    <div class="row">
                        <div class="col-lg-3">
                            <div class="form-group">
                                ...
                                <input type="date" name="dtrfrom" id="datefrom" onchange="daterange()" class="form-control" value="<?= $datef; ?>" required>
                            </div>
                        </div>
                        <div class="col-lg-3">
                            <div class="form-group">
                                <label>To <span style="color: red;">*required</span></label>
                                <input type="date" name="dtrto" id="dateto" onchange="daterange()" class="form-control" value="<?= $datet; ?>" required>
                            </div>
                        </div>
                        <div class="col-lg-2">
