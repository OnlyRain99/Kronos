<?php  
    ...
    if (isset($_POST['approve'])) {
        ...
        //approve
        $updatedata=$link->query("UPDATE `gy_tracker` SET `gy_tracker_wh`='$minus_wh',`gy_tracker_ot`='$final_ot',`gy_tracker_request`='$opt_value',`gy_tracker_om`='$user_id' Where `gy_tracker_id`='$redirect'");
        ...
        if ($mode == "normal") {
            ...
            if ($updatedata) {
                header("location: search_master?note=app&s=$s&f=$f&t=$t&a=$a&b=$b");
            }else{
                header("location: search_master?note=app&s=$s&f=$f&t=$t&a=$a&b=$b");
            }
        }
    ...
    if (isset($_POST['update'])) {
        ...
        if ($mode == "normal") {
            ...
            if ($updatedata) {
                header("location: search_master?note=rej&s=$s&f=$f&t=$t&a=$a&b=$b");
            }else{
                header("location: search_master?note=app&s=$s&f=$f&t=$t&a=$a&b=$b");
            }
        }
