<?php  
    ...
    //get dtr logs
    $tracks=$link->query("SELECT * From `gy_tracker` Where month(`gy_tracker_date`)='$thismonth' AND `gy_emp_code`='$empcode' Order By `gy_tracker_date` DESC");
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <strong><?php echo $inforow['gy_emp_code']." - ".$inforow['gy_emp_fullname']; ?> </strong>record <span class="pull-right" style="font-style: italic;"><span style="color: blue;"><?= date("F"); ?></span> record</span>
                        </div>
                        <div class="card-body">
