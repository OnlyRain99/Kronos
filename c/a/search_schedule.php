<?php  
    ...
    $schedules=$link->query("SELECT * From `gy_schedule` Where `gy_emp_id`='$redirect' AND `gy_sched_day` BETWEEN '$datef' AND '$datet' Order By `gy_sched_day` ASC LIMIT 35");
    $countresults=$schedules->num_rows;
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <strong><?php echo $inforow['gy_emp_code']." - ".$inforow['gy_emp_fullname']; ?> </strong>schedule <small><span style="color: blue;"><?= $countresults; ?></span> result(s)</small> <span class="pull-right" style="font-style: italic;">up to <span style="color: blue;">35</span> rows only</span>
                        </div>
                        <div class="card-body">
                                        ...
                                        <table class="table table-bordered" style="font-family: 'Calibri'; font-size: 14px;">
                                            ...
                                            <tbody>
                                                ...
                                                <tr class="mybg">
                                                    ...
                                                    <?php
                                                        $schedid = $schedrow['gy_sched_id'];

                                                        $edit_link = "update_sched?cd=$redirect=&dir=$schedid&mode=search&datef=$datef&datet=$datet";
                                                        $delete_link = "delete_sched?cd=$redirect=&dir=$schedid&mode=search&datef=$datef&datet=$datet";
