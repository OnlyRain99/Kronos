...
?>
	<div class="col-md-6">
		<div class="card">
				...
				<!--<div style="height: 400px; overflow: auto;" class="btn-group-vertical" id="lstoftool">-->
				<div style="height: 400px; overflow: auto;" id="lstoftool">
...
<?php } ?>
	...
	<div class="col-md-6" id="tooldsply">
		<!--<div class="card" id="tooldsply" >
		</div> -->
	</div>
