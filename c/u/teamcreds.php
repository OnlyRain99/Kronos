<?php 
    ...
    $title = "Team Tool Records";

 if($user_type == 1 && $user_dept == 3){
    ...
    $tmrow=$tmsql->fetch_array();
        ...
        if($teamarr[2]==$user_code){
            $link->query("UPDATE `team_toollist` SET `team_switch`=1 Where `team_id`=$teamarr[0]");
        }
    }
...
<body>
               ...
               <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <ul class="nav nav-tabs">
                            ...
                            <li class="nav-item"><a class="nav-link active" aria-current="page" href="teamcreds"><strong><i class="fa-solid fa-users-rectangle"></i> Team Tool Records</strong></a></li>
    ...
    <script type="text/javascript">
        ...
        function switchteam(i, name){
            Swal.fire({
                title: 'Move <b>'+name+'</b> to <i class="fa-solid fa-user-secret"></i> <b>My Tool Records</b>?',
                icon: 'question',
                showCancelButton: true,
                confirmButtonColor: '#3085d6',
                cancelButtonColor: '#d33',
                confirmButtonText: 'Move <i class="fa fa-angle-double-right"></i>',
                cancelButtonText: '<i class="fa-solid fa-ban"></i> Cancel'
            }).then((result) => {
        ...
        function search(){
            ...
            sendpost("tblcontentlst","itcard/loadnmlist.php","search=1&tooltyp=1&toolnm="+txt.value);
        }
        ...
        function cnfrmnew(){
            ...
            if(txt.value!=""){
                Swal.fire({
                    ...
                    if(result.isConfirmed){
                        sendpost("tblcontentlst","itcard/loadnmlist.php","search=0&tooltyp=1&toolnm="+txt.value);
                        txt.value="";
                    }
                })
            }
        ...
        function loadstart(){
            sendpost("tblcontentlst","itcard/loadnmlist.php","search=1&tooltyp=1&toolnm=");
        }
