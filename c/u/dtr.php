...
<body>
    ...
    <script type="text/javascript">
        ...
        function autosearch(){
            ...
            xhttp.open("POST", "dtr/dtr_search.php", true);
        ...
        function sel_search(){
            ...
            var xhttp = new XMLHttpRequest();
            if(selby==0 && selop==0){
            sendpost("ff_srchlst", "dtr/dtr_searchtxtbx.php", "", 0);
            }else if(selby==0 && selop==1){
            sendpost("ff_srchlst", "dtr/dtr_emplist.php", "selby="+selby, 0);
            }else if(selby==1){
            sendpost("ff_srchlst", "dtr/dtr_emplist.php", "selby="+selby+"&lvlsel="+selop, 0);                
            }else if(selby==2){
            sendpost("ff_srchlst", "dtr/dtr_emplist.php", "selby="+selby+"&lvlsel="+selop, 0);                
            }else if(selby==3){
            sendpost("ff_srchlst", "dtr/dtr_emplist.php", "selby="+selby+"&lvlsel="+selop, 0);                
        ...
        function sel_by(){
            var selby = document.getElementById("slt_by").value;
            var sel_source = "";
            if(selby==0){ sel_source = "dtr/dtr_selall.php"; }
            else if(selby==1){ sel_source = "dtr/dtr_levellst.php"; }
            else if(selby==2){ sel_source = "dtr/dtr_accountlst.php"; }
            else if(selby==3){ sel_source = "dtr/dtr_departmentlst.php"; }
