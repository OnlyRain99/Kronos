                                    ...
                                    <div class="row">
                                        <div class="col-lg-3">
                                            <div class="form-group">
                                                ...
                                                <input type="date" name="datefrom" id="datefrom" onchange="daterange()" value="<?php echo $datefrom ?>" class="form-control" required>
                                            </div>
                                        </div>
                                        <div class="col-lg-3">
                                            <div class="form-group">
                                                <label style="color: blue;">*to</label>
                                                <input type="date" name="dateto" id="dateto" onchange="daterange()" value="<?php echo $dateto; ?>" class="form-control" required>
                                            </div>
                                        </div>
                                        <div class="col-lg-3">
                                            <div class="form-group">
