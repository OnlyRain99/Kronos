...
for($i1=0;$i1<$i;$i1++){ ?>
<tr>
   <td style="padding:0px;" ><button class="btn btn-outline-danger btn-sm btn-block" onclick="removepblshdtr(<?php echo $pblsharr[$i1][0]; ?>)"><i class="fa-solid fa-trash"></i></button></td>
