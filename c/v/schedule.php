        ...
        <div class="page-container">
            ...
            <div class="main-content" style="padding: 20px;">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h2 class="title-1 m-b-25"><?php echo $title; ?> <i class="fas fa-calendar"></i></h2>
                        </div>
                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-3">
                                            <div class="form-group">
                                                ...
                                                <input type="date" name="s_datefrom" id="datefrom" onchange="daterange()" class="form-control" required>
                                            </div>
                                        </div>
                                        <div class="col-lg-3">
                                            <div class="form-group">
                                                <label style="color: blue;">*to</label>
                                                <input type="date" name="s_dateto" id="dateto" onchange="daterange()" class="form-control" required>
                                            </div>
                                        </div>
                                        <div class="col-lg-3">
                                            <div class="form-group">
                                                <label style="color: blue;">*submit</label><br>
...
$datefrom = "";
$dateto = "";
if(date("d")>15){$datefrom=date("Y-m-16"); $dateto=date("Y-m-t");}
else{$datefrom=date("Y-m-01"); $dateto=date("Y-m-15");}
...
function getdaystatus($holdate){
    ...
    <script type="text/javascript">  
        function validateForm(formObj) {
            ...
            formObj.submit.innerHTML = "searching schedules ...";
            return true;  
        }  
    </script>
