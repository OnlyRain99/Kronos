<?php 
    ...
    $confirmations=$link->query("SELECT `gy_emp_code`,`gy_emp_fullname`,`gy_emp_supervisor`,`gy_conf_date`,`gy_conf_by`,`gy_ann_id` From `gy_employee` LEFT JOIN `gy_confirm` On `gy_employee`.`gy_emp_code`=`gy_confirm`.`gy_conf_by` Where `gy_emp_type` IN ('1','2','3','11','12') Order By `gy_emp_fullname` ASC LIMIT 0");
                                            ...
                                            <div class="table-responsive m-b-40">
                                                <table class="table table-bordered" style="font-family: 'Calibri'; font-size: 14px;">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <?php  
                                                            //get confirmations
                                                            while ($cons=$confirmations->fetch_array()) {
