        ...
        <div class="page-container">
            ...
            <div class="main-content" style="padding: 20px;">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h2 class="title-1 m-b-25"><?php echo $title; ?> <span style="font-size: 15px; text-transform: lowercase;" class="badge badge-success"><?php echo 0 + $counttracks; ?> results</span></h2>
                                ...
                                <table class="table table-bordered" style="font-family: 'Calibri'; font-size: 14px;">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="mybg">
                                            ...
                                            <td class="text-center" style="padding: 0px; color: #fff;"><button type="button" data-toggle="modal" data-target="#info_<?= $trackrow['gy_tracker_id'];  ?>" class="btn btn-warning btn-sm" title="click to show details ..."><i class="fa fa-eye"></i></button></td>
                                            <td class="text-center" style="padding: 0px; color: #fff;"><button type="button" data-toggle="modal" data-target="#edit_<?= $trackrow['gy_tracker_id'];  ?>" class="btn btn-info btn-sm" title="click to edit ..."><i class="fa fa-edit"></i></button></td>
                                            <td class="text-center" style="padding: 0px; color: #fff;"><button type="button" data-toggle="modal" data-target="#app_<?php echo $trackrow['gy_tracker_id']; ?>" class="btn btn-success btn-sm" title="click to approve ..."><i class="fa fa-thumbs-up"></i></button></td>
                                            <td class="text-center" style="padding: 0px; color: #fff;"><button type="button" data-toggle="modal" data-target="#rej_<?php echo $trackrow['gy_tracker_id']; ?>" class="btn btn-danger btn-sm" title="click to reject ..."><i class="fa fa-thumbs-down"></i></button></td>
                                        </tr>
