<?php  
    ...
    //get dtr logs
    $schedule=$link->query("SELECT * From `gy_schedule` Where `gy_emp_id`='$myid' AND `gy_sched_day` BETWEEN '$datefrom' AND '$dateto' Order By `gy_sched_day` ASC");
?>
        ...
        <div class="page-container">
            ...
            <div class="main-content" style="padding: 20px;">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h2 class="title-1 m-b-25"><?php echo $title; ?> <i class="far fa-calendar"></i></h2>
                        </div>
                    </div>
