                    ...
                    <div class="row">
                        <div class="col-lg-3">
                            <div class="form-group">
                                ...
                                <input type="date" name="dtrfrom" id="datefrom" onchange="daterange()" value="<?= $datef; ?>" class="form-control" required>
                            </div>
                        </div>
                        <div class="col-lg-3">
                            <div class="form-group">
                                <label>To <span style="color: red;">*required</span></label>
                                <input type="date" name="dtrto" id="dateto" onchange="daterange()" value="<?= $datet; ?>" class="form-control" required>
                            </div>
                        </div>
                        <div class="col-lg-2">
