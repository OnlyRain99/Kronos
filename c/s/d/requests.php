                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="table-responsive m-b-40">
                                <form method="post" enctype="multipart/form-data" action="approve_all?mode=normal&pn=<?= $pagenum; ?>">
