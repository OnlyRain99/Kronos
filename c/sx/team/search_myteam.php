...
?>
<tr class="mybg">
<td style="padding: 3px;" class="text-center <?php echo $txtcolor[1]; ?>"><?php echo $name; ?></td>
<td style="padding: 3px;" class="text-center <?php echo $txtcolor[1]; ?>"><?php echo $date; ?></td>
<td style="padding: 3px;" class="text-center <?php echo $txtcolor[2]; ?>" title="<?php echo simpdate($in); ?>">
	<?php echo chktime($in); ?>
</td>
<td style="padding: 3px;" class="text-center <?php echo $txtcolor[3]; ?>" title="<?php echo simpdate($bout); ?>">
	<?php echo chktime($bout); ?>
</td>
<td style="padding: 3px;" class="text-center <?php echo $txtcolor[4]; ?>" title="<?php echo simpdate($bin); ?>">
	<?php echo chktime($bin); ?>
</td>
<td style="padding: 3px;" class="text-center <?php echo $txtcolor[5]; ?>" title="<?php echo simpdate($out); ?>">
	<?php echo chktime($out); ?>
</td>
<td style="padding: 3px;" class="text-center <?php echo $txtcolor[1]; ?>"><?php echo chktime($si); ?></td>
<td style="padding: 3px;" class="text-center <?php echo $txtcolor[1]; ?>"><?php echo chktime($so); ?></td>
<td style="padding: 3px;" class="text-center <?php echo getcolor($mode, $txtcolor[1], $wh - $bh); ?>"><?php if($bh>1 && $wh>=5){echo gettwh($wh - 1);}else{ echo gettwh($wh - $bh); } ?></td>
<td style="padding: 3px;" class="text-center <?php echo $txtcolor[1]; ?>"><?php echo round($bh, 2); ?></td>
<td style="padding: 3px;" class="text-center <?php echo $txtcolor[1]; ?>"><?php echo round($ot, 2); ?></td>
<td style="padding: 3px;" class="text-center text-danger"><?php echo round($utl[0]+$utl[1],2); ?></td>
<td style="padding: 3px;" class="text-center <?php echo $txtcolor[0]; ?>"><?php echo round($theath, 2); ?></td>
<td id="c2_<?php echo $trackid; ?>" style="padding: 3px;" class="text-center <?php echo $txtcolor[1]; ?>"><i><?php echo $omname; ?></i></td>
<td style="padding: 0px;" class="text-center">
	<?php if($trackid!="" || $loa[0]==1){ ?>
	<button type="button" data-toggle="modal" data-target="#info_<?php echo $trackid; ?>" class=" btn-warning btn-sm btn-block" title="click to show details ..."><i class="fa fa-eye"></i></button>
	<?php } ?>
</td>
</tr>
<?php if($trackid!="" || $loa[0]==1){ ?>
