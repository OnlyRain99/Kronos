<?php 
    ...
    $query_one = "SELECT * From `gy_announce` Where date(`gy_ann_end`) < '$onlydate' Order By `gy_ann_date` DESC";
    $query_two = "SELECT COUNT(`gy_ann_id`) From `gy_announce` Where date(`gy_ann_end`) < '$onlydate' Order By `gy_ann_date` DESC";
    $query_three = "SELECT * From `gy_announce` Where date(`gy_ann_end`) < '$onlydate' Order By `gy_ann_date` DESC ";
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <h2 class="title-1 m-b-25"><?= $title; ?> <i class="fa fa-folder-open"></i></h2>
                            </div>
