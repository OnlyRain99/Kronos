...
<body>
    ...
    <script type="text/javascript">
        ...
        function loacfrmresponse(status){
            ...
            else if(status=="xprdreq"){ status="error"; title="Team LOA request was invalid or expired"; }
      ...
      document.addEventListener('DOMContentLoaded', function(){
        ...
        dateClick: function(info){
            ...
            sendpost("pltdtyl","leave/plotview.php", "startdate="+info.dateStr+"&pltvw=3");
        },
