<div class="modal fade" id="edit_<?= $ann['gy_ann_id']; ?>" tabindex="-1" role="dialog" aria-labelledby="mediumModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form method="post" enctype="multipart/form-data" action="announcement/update_announce?cd=<?= $ann['gy_ann_id']; ?>" onsubmit="return validateForm(this);">
...
<div class="modal fade" id="delete_<?= $ann['gy_ann_id']; ?>" tabindex="-1" role="dialog" aria-labelledby="smallModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
                <a href="announcement/delete_announce?cd=<?= $ann['gy_ann_id']; ?>"><button type="button" class="btn btn-danger">Delete</button></a>
            </div>
            </form>
        </div>
    </div>
