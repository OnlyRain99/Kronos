...
<?php if($user_dept==3 && rand(0,100)==25){ ?><script src="../../vendor/3d-multi-layer-tilt-hover-effect/scripts.js"></script><?php } ?>
...
if(<?php if($user_dept==3){echo"true";}else{echo"false";} ?> && Math.floor(Math.random() * 5)==3){
$(function(){
  $("#weblogo").shakker({
    x:true,
    y:true,
