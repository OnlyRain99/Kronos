                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <h2 class="title-1 m-b-25"><?= $title.$search_text; ?> <span style="font-size: 15px; text-transform: lowercase;" class="badge badge-success"><?php echo 0 + $countres; ?> results</span></h2>
                            </div>
                        </div>
                    </div>
                    <div class="row">
