<?php 
    ...
    $title = "Approved Escalation Request";
...
<body class="">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <ul class="nav nav-tabs">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="approverequest">Approved Request</a>
                        </li>
                        <li class="nav-item">
    ...
    <script type="text/javascript">
        ...
        function loadtblescrqst(pgnm){
            sendpost("tblescrqst", "escalationrequest/showapproveesc.php", "pgnm="+pgnm);
        }
